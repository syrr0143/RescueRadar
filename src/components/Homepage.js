...
export default function Homepage() {
  ...
  return (
    <div>
        <nav className="navbar navbar-expand-lg navbar-bg text-colour" style={{height:"11.5vh"}}>
        <div className="container-fluid">
          <Link className="navbar-brand" to="#" ><img src={logo} alt="" style={{ width: "70px", height: "55px" }} /></Link> 
          ...
          <div className="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <ul className="navbar-nav ml-auto"> {/* Right-aligned items */}
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/Logout" style={{color:"#FFF",fontSize:"16px"}} >Logout</Link> 
              </li>
            </ul>
          </div>
        </div>
